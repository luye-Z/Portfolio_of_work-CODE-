...
blob_threshold_rgb=[5, 100,-127,127,-127,127]#(L Min, L Max, A Min, A Max, B Min, B Max)
...
def opv_find_color_blob():
    ...
    if (ctr.work_mode&0x01)!=0:
        ...
        pixels_max=0
        for b in img.find_blobs([blob_threshold_rgb],pixels_threshold=1,merge=True,margin=100):
